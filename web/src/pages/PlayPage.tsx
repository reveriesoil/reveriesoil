...
import type { GameDetail, Scene, Character } from '../types'
...
export default function PlayPage() {
  ...
  return (
    <div className="vn-player" onClick={!showChoices && !showSceneTitle ? advance : undefined}>
      {/* 背景 */}
      ...
      <AnimatePresence>
        {leftPortrait && !showChoices && !showSceneTitle && (
          ...
          >
            <img src={leftPortrait} className={`vn-portrait${leftActive ? '' : ' vn-portrait--inactive'}`} alt={leftChar?.name} />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {rightPortrait && !showChoices && !showSceneTitle && (
          <motion.div
            ...
            transition={{ duration: 0.35 }}
          >
            <img src={rightPortrait} className={`vn-portrait${rightActive ? '' : ' vn-portrait--inactive'}`} alt={rightChar?.name} />
          </motion.div>
        )}
      </AnimatePresence>
